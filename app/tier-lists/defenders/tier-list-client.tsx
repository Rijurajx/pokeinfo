    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="bg-card rounded-lg p-6 mb-6 border border-border">
          <h1 className="text-4xl font-bold text-foreground mb-4">Best Defenders Tier List</h1>
          <div className="flex flex-col md:flex-row gap-6 items-start">
            <div className="flex-1">
              <p className="text-muted-foreground mb-4 leading-relaxed">
                Discover the toughest Pokémon to take down in Pokémon GO. This Defenders Tier List ranks Pokémon
                by their defensive power — combining high stamina, defense, and advantageous typings to resist
                common raid attackers. Perfect for Trainers looking to build sturdy gym defenders and reliable raid tanks.
              </p>
              <p className="text-xs text-muted-foreground italic">
                Note: Pokémon inside every tier are sorted by their overall defensive potential.
              </p>
            </div>
            <div className="w-full md:w-64 flex-shrink-0">
              <Image
                src="/pokemon-go-defense-banner.jpg"
                alt="Best Defenders Tier List"
                width={256}
                height={256}
