...
export const TIER_DATA: Record<string, TierData> = {
  ...
  name: "C Tier",
  description:
    "C Tier Pokémon are situational defenders. They can serve decently in gyms or certain PvE contexts but are generally less efficient than top-tier options. Many here shine due to unique typing, bulk, or niche coverage.",
  color: "bg-blue-400",
  pokemon: [
    ...
    { id: 3, name: "Gigantamax Venusaur", types: ["grass", "poison"] },
    ...
    { id: 59, name: "Hisuian Arcanine", types: ["fire", "rock"] },
    { id: 423, name: "Gastrodon (East Sea)", types: ["water", "ground"] },
    { id: 423, name: "Gastrodon (West Sea)", types: ["water", "ground"] },
    { id: 832, name: "Dubwool", types: ["normal"] },
    { id: 452, name: "Drapion", types: ["poison", "dark"] },
    { id: 711, name: "Gourgeist (Average Size)", types: ["ghost", "grass"] },
    ...
    { id: 38, name: "Alolan Ninetales", types: ["ice", "fairy"] },
    ...
    { id: 628, name: "Hisuian Braviary", types: ["psychic", "flying"] },
  ],
},
...
D: {
  name: "D Tier",
  description:
    "D Tier Pokémon are niche or outdated defenders. They can fill space in gyms but are generally easy to defeat and not worth investing Stardust or Candy in for defensive purposes.",
  color: "bg-blue-300",
  pokemon: [
    ...
    { id: 479, name: "Frost Rotom", types: ["electric", "ice"] },
    { id: 479, name: "Heat Rotom", types: ["electric", "fire"] },
    { id: 479, name: "Mow Rotom", types: ["electric", "grass"] },
    { id: 479, name: "Wash Rotom", types: ["electric", "water"] },
